...
describe('Last', () => {
    ...
    it('given an empty array, throw an exception', () => {
        ...
        // WHEN
        const result = () => Last.execute(values, (it) => it);
    ...
    it('given an array of numbers, no value matching the predicate, throw an exception', () => {
        ...
        // WHEN
        const result = () => Last.execute(values, (it) => it === 0);
    ...
    it('given an array of numbers, return the last value matching the predicate', () => {
        ...
        // WHEN
        const result = Last.execute(values, (it) => it === 3);
    ...
    it('given an array of persons, return the last person matching the predicate', () => {
        ...
        // WHEN
        const result = Last.execute(values, (it) => it.age === 19);
