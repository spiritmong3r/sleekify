...
describe('None', () => {
    ...
    it('given an array of strings containing a single value 4, return false', () => {
        ...
        // WHEN
        const result = None.execute(values, (it) => it === '4');
    ...
    it('given an array of strings not containing value 4, return true', () => {
        // GIVEN
        const values = ['1', '2', '5', '4', '3', '9', '0'];

        // WHEN
        const result = None.execute(values, (it) => it === '34');
    ...
    it('given an array of persons containing a single 18 yo person, return false', () => {
        ...
        // WHEN
        const result = None.execute(values, (it) => it.age === 18);
    ...
    it('given an array of persons not containing a 35 yo person, return true', () => {
        // GIVEN
        const values = [PersonMock.ed(), PersonMock.jane(), PersonMock.jo(), PersonMock.bob()];

        // WHEN
        const result = None.execute(values, (it) => it.age === 35);
