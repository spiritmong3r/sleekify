...
import {MaxByOperation} from './max-by.operation';

describe('MaxByOperation', () => {
    ...
    it('given an empty array, return undefined value', () => {
        ...
        // WHEN
        const result = MaxByOperation.execute(values, (it) => it);
    ...
    it('given an array of persons, return the oldest one', () => {
        ...
        // WHEN
        const result = MaxByOperation.execute(values, (it) => it.age);
