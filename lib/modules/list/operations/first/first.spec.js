...
describe('First', function () {
    it('given an empty array, throw an exception', function () {
        ...
        var values = [];
        // WHEN
        var result = function () { return first_1.First.execute(values, function (it) { return it; }); };
        // THEN
    ...
    it('given an array of numbers, no value matching the predicate, throw an exception', function () {
        ...
        // WHEN
        var result = function () { return first_1.First.execute(values, function (it) { return it === 0; }); };
        // THEN
        expect(result).toThrowError('No value matches the predicate');
    });
    it('given an array of numbers, return the first value matching the predicate', function () {
        ...
        var values = [1, 2, 3, 4, 5];
        // WHEN
        var result = first_1.First.execute(values, function (it) { return it === 3; });
        // THEN
        var expected = 3;
    ...
    it('given an array of persons, return the first person matching the predicate', function () {
        ...
        // WHEN
        var result = first_1.First.execute(values, function (it) { return it.age === 19; });
        // THEN
