...
describe('Drop', function () {
    it('given an empty array, drop 5 and return an empty List', function () {
        ...
        var n = 5;
        // WHEN
        var result = drop_1.Drop.execute(values, n);
        // THEN
    ...
    it('given an array of numbers, drop 2 and return an array without the 2 first numbers', function () {
        // GIVEN
        var values = [1, 2, 3, 4, 5];
        var n = 2;
        // WHEN
        var result = drop_1.Drop.execute(values, n);
        // THEN
        var expected = new list_1.List(3, 4, 5);
        expect(result).toEqual(expected);
    });
});
